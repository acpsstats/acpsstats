			...
			<div>
				...
				<?php 
				 ...
				 $show_record = isset($_REQUEST['show_record']) ? ($_REQUEST['show_record']) : '';
					...
					/*
                    if($_SERVER['SERVER_ADDR']=='114.69.235.39' || $_SESSION['user_id']==2 ){
		       ...
		       <?php if($success != ''){ ?>
				...
				<div class="box span12">
					...
					<div class="record-validate-user">
					  <h2>DATA ENTRY</h2>
					  <span class="user">Username :</span>  <span class="val">
					  <?php  echo get_username($results["user_id"]); ?> 
					  </span>
					...
					<div id="horizontalTab">
						...
						<div id="tab-5" class="tabs_sections">
								...
								<h4>COMPLICATION (Must have occurred within 30 days of admission)</h4>
								<?php 
									$value='';
									$new_st='';
									for($i=1;$i<=5;$i++){
